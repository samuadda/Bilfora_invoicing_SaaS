-- Migration: Fix create_invoice_with_items RPC search path issues
-- Description: Fully qualifies table names with 'public.' since search_path is set to empty string.
