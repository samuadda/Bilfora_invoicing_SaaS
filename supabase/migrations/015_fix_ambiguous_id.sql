-- Migration: Fix ambiguous 'id' column reference in create_invoice_with_items RPC
-- Description: Explicitly qualifies 'RETURNING invoices.id' to avoid conflict with output parameter 'id'.
...
BEGIN
  ...
  RETURNING invoices.id INTO v_invoice_id; -- FIXED: Qualified column name
