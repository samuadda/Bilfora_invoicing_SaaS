-- Add multiple payment methods to invoice_settings
ALTER TABLE public.invoice_settings
ADD COLUMN IF NOT EXISTS bank_name_2 text,
ADD COLUMN IF NOT EXISTS iban_2 text,
ADD COLUMN IF NOT EXISTS bank_name_3 text,
ADD COLUMN IF NOT EXISTS iban_3 text;

-- Add payment_info to invoices to store the selected payment method details
ALTER TABLE public.invoices
ADD COLUMN IF NOT EXISTS payment_info jsonb;

-- Update create_invoice_with_items RPC to accept and set payment_info
