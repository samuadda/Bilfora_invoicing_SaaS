-- Migration: Fix create_invoice_with_items RPC ambiguous id column
-- Description: The 'id' column in the RETURNING clause conflicts with the 'id' OUT parameter. Explicitly qualifying as public.invoices.id.
