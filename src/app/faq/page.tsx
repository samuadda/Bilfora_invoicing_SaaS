...
const faqData: FAQItem[] = [
	{
		...
		answer: "يمكنك إنشاء فاتورة جديدة بسهولة من خلال الضغط على زر 'إنشاء فاتورة' في لوحة التحكم، ثم ملء البيانات المطلوبة مثل معلومات المشتري والمنتجات والخدمات.",
