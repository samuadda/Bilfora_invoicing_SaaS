...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "نعم، جميع الفواتير الصادرة من بِلفورا متوافقة مع متطلبات هيئة الزكاة والضريبة والجمارك في المملكة العربية السعودية. الفواتير تحتوي على جميع البيانات المطلوبة قانونياً وتكون جاهزة للطباعة أو الإرسال الإلكتروني.",
    icon: Shield,
  },
  {
